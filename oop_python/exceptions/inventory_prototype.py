class Inventory:
    ...
    def purchase(self, item_type):
        """If the item is not lockec, raise an exception. If the item_type does
        not exist, raise an exception. If the item is currently out of stock,
        raise an excpetion. If the item is available, subtract one item and         
